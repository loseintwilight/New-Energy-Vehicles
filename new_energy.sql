...
CREATE TABLE `stad_charging_rate_period`  (
  ...
  `price_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'workday' COMMENT 'workday=工作日, weekend=周末, holiday=节假日',
...
) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '充电费率时段表（峰谷平+工作日/周末/节假日）' ROW_FORMAT = Dynamic;
